...
export class ProdutoService {
  ...
  findByCliente(cliente_id: string, page: number = 0, linesPerPage: number = 24) {
    return this.http.get(`${API_CONFIG.baseUrl}/produtos/?cliente=${cliente_id}&page=${page}&linesPerPage=${linesPerPage}`);
  }
